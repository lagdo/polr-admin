    ...
    <link rel="stylesheet" href="{{ url('lagdo/polr/admin') }}/css/datatables.min.css" />
    <link rel="stylesheet" href="{{ url('lagdo/polr/admin') }}/css/jquery-jvectormap.css" />
    <link rel="stylesheet" href="{{ url('lagdo/polr/admin') }}/css/bootstrap-datetimepicker.min.css" />
    <style>
    #mapChart {
        height: 24em;
    }
